...
import { Activity, Menu, MoonStar, SunMedium, Workflow } from "lucide-react";
...
export function TopBar({
  ...
  const title = workspaceMode === "admin" ? "Enterprise Admin Console" : "Global Agent Workspace";
  const subtitle =
    workspaceMode === "admin"
      ? "Governance controls, routing observability, and specialist oversight"
      : "Global Agent handles specialist routing automatically";
      ...
      <div className="mx-auto flex w-full max-w-[1500px] items-center justify-between gap-3">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="hidden min-w-0 lg:block">
            <h1 className="truncate font-display text-sm font-semibold tracking-wide text-slate-900 dark:text-slate-100">{title}</h1>
